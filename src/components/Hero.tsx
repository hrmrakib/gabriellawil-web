...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[url('/hero2.png')] md:bg-[url('/hero.png')] bg-cover bg-center h-screen w-full py-12 md:py-24">
      ...
      <div className='container mx-auto h-full relative z-10 px-4 md:px-6'>
        <div className='min-h-full md:grid items-center md:justify-center gap-6 lg:grid-cols-2 lg:gap-12'>
          <div className='flex flex-col gap-4 items-center md:justify-center'>
